...
resolved path to be under `references/contracts/`, and reject missing,
ambiguous, external, or recursive contract references. Do not load an
unselected contract.
...
Treat JSON returned by `scripts/sdd.py` as the sole source of truth for generated
