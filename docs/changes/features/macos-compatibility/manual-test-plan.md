...
Для провайдера Nessy дополнительно выполнить
[приёмку адаптера и авторизации](../nessy-adapter-auth/manual-test-plan.md)
на этом же физическом Apple Silicon Mac.
